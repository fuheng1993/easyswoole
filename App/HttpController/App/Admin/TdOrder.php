...
namespace App\HttpController\App\Admin;
...
{
	/**
	 * @api {get|post} /App/Admin/TdOrder/add
	 * @apiName add
	 * @apiGroup /App/Admin/TdOrder
	 * @apiPermission
	...
	/**
	 * @api {get|post} /App/Admin/TdOrder/update
	 * @apiName update
	 * @apiGroup /App/Admin/TdOrder
	 * @apiPermission
	...
	/**
	 * @api {get|post} /App/Admin/TdOrder/getOne
	 * @apiName getOne
	 * @apiGroup /App/Admin/TdOrder
	 * @apiPermission
	...
	/**
	 * @api {get|post} /App/Admin/TdOrder/getAll
	 * @apiName getAll
	 * @apiGroup /App/Admin/TdOrder
	 * @apiPermission
	...
	/**
	 * @api {get|post} /App/Admin/TdOrder/delete
	 * @apiName delete
	 * @apiGroup /App/Admin/TdOrder
	 * @apiPermission
